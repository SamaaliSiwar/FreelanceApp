...
const submitHandler = async (e) => {
  e.preventDefault();
  try {
    const url = "http://localhost:5000/api/auths/signup";
  ...
  return (
    ...
    <MDBCard>
          ...
          <MDBCardBody className='d-flex flex-column'>
            ...
            <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px'}}>créer un compte Freelancer </h5>
    ...
    <MDBInput wrapperClass='mb-4 mt-2' label='Email address' id='formControlLg' type='email' size="lg"  onChange={(e) => setEmail(e.target.value)}/>
            ...
            <p className="mb-5 pb-lg-2" style={{color: '#393f81'}}>vous avez déja un compte? <a href="/login" style={{color: '#393f81'}}>connectée</a></p>
