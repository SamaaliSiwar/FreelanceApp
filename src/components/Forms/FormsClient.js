...
const submitHandler = async (e) => {
  e.preventDefault();
  try {
    const url = "http://localhost:5000/api/auths/client/login";
  ...
  return (
    ...
    <MDBCard>
          ...
          <MDBCardBody className='d-flex flex-column'>
            ...
            <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px'}}>Connecté en tant que Client</h5>
            ...
            <p className="mb-5 pb-lg-2" style={{color: '#393f81'}}>vous n'avez pas de compte? <a href="/client/register" style={{color: '#393f81'}}>S'inscrire</a></p>
