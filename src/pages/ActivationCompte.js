...
const ActivationCompte = () => {
  ...
  useEffect(() => {
    const Active= async () => {
      try {
        const url = `http://localhost:5000/api/auths/verife/${veriftoken}`;
...
<Alert severity="success" style={{textAlgin:'center'}}>Votre compte est activée!<br/>  <strong>connectée à votre compte</strong></Alert>
    <MDBCard>
          ...
          <MDBCardBody className='d-flex flex-column'>
            ...
            <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px'}}>connectée en Tant que Freelancer</h5>
            ...
            <MDBBtn className="mb-4 px-5" color='dark' size='lg' type='submit'>Connextion</MDBBtn>
            </form>
            <a className="small text-muted" href="#!">mdp oblier?</a>
            <p className="mb-5 pb-lg-2" style={{color: '#393f81'}}>vous n'avez pas de compte? <a href="/register" style={{color: '#393f81'}}>S'nscrire</a></p>
